...
import com.kmartin0.sceneformexample.util.DimenUtils;
import com.kmartin0.sceneformexample.ui.ar.node.CustomNode;
...
public abstract class SingleModelARActivity<VDB extends ViewDataBinding, BVM extends BaseViewModel>
	...
	private RenderableSource.SourceType getSourceType(Uri modelURI) {
		...
		if (uri.contains("gltf")) return RenderableSource.SourceType.GLTF2;
		if (uri.contains("glb")) return RenderableSource.SourceType.GLB;
